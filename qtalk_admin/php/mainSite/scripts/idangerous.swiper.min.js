...
var Swiper = function (selector, params) {
    ...
    var defaults = {
        ...
        noSwiping: false,
        noSwipingClass: "pc-mod-swiper-no-swiping",
        initialSlide: 0,
        ...
        swipeToNext: true,
        slideElement: "div",
        slideClass: "pc-mod-swiper-slide",
        slideActiveClass: "pc-mod-swiper-slide-active",
        slideVisibleClass: "pc-mod-swiper-slide-visible",
        slideDuplicateClass: "pc-mod-swiper-slide-duplicate",
        wrapperClass: "pc-mod-swiper-wrapper",
        paginationElementClass: "pc-mod-swiper-pagination-switch",
        paginationActiveClass: "pc-mod-swiper-active-switch",
        paginationVisibleClass: "pc-mod-swiper-visible-switch",
        paginationcontent: ["index1", "index2"]
    };
    params = params || {};
    ...
    _this.createPagination = function (firstInit) {
        ...
        if (params.createPagination) {
            ...
            for (var i = 0; i < numOfButtons; i++) {
                console.log();
                paginationHTML += "<" + params.paginationElement + ' class="' + params.paginationElementClass + " customer" + i + '">' + params.paginationcontent[i] + "</" + params.paginationElement + ">"
            }
    ...
    _this.updatePagination = function (position) {
        ...
        if (params.paginationAsRange) {
            ...
            var visibleIndexes = [];
            var j;
            for (j = 0; j < _this.visibleSlides.length;
                 j++) {
    ...
    _this.createLoop = function () {
        ...
        for (i = numSlides - remainderSlides;
             i < numSlides; i++) {
